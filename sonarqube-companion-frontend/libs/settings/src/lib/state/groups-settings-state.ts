...
import {
  GroupDetails,
  GroupService,
} from '@sonarqube-companion-frontend/group';
...
export class GroupsSettingsState implements NgxsOnInit {
  constructor(
    ...
    private groupsConfigService: GroupsConfigService
  ) {}
  ...
  addChild(
    ...
    return this.groupsConfigService
      ...
      .pipe(tap(() => ctx.dispatch(new LoadRootGroup())));
  }
}
