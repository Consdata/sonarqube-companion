      ...
      <div class="preview" *ngIf="!expanded">
        <div class="wrapper">
          ...
          <div class="actions" *ngIf="areActionsAllowed(); else spinner">
            <sqc-select [icon]="'more_vert'" [menu]="true">
      ...
      <div class="container" *ngIf="expanded" [class.error]="message">
        ...
        <div class="row">
          <div class="item">
            <sqc-select
              [text]="'Authorization:'"
              [default]="server.authentication.type"
        ...
        <div class="row">
          ...
          <div class="blacklist item">
            <sqc-chips
              [label]="'MEMBERS BLACKLIST'"
              [placeholder]="'member id'"
              [items]="server.blacklistUsers"
            ></sqc-chips>
          </div>
        </div>
      </div>
...
export class ServerComponent {
  ...
  areActionsAllowed(): boolean {
    if (this.server) {
      return this.spinnerService.isUnlocked(
        Locks.SERVER_ACTION + this.server.uuid
      );
    } else {
      return false;
    }
