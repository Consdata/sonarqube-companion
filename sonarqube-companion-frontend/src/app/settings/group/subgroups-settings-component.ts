  ...
  template: `
    ...
    <div *ngIf="loaded" class="sq-settings-container">
      ...
      <div class="tree-wrapper">
        <div class="tree-phony-root" [class.selected]="!this.selectedNode" (click)="onTreePhonyRootClick()">..</div>
        <tree-root #tree
                   [nodes]="groups"
                   [options]="options"
...
export class SubgroupsSettingsComponent {
  ...
  constructor(private router: Router, private settingsService: GroupSettingsService) {
  }
