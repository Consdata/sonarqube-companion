...
public class Caches {
    ...
    public static final String GROUP_PROJECT_VIOLATIONS_HISTORY_CACHE = "group_project_violations_history";
    public static final String GROUP_PROJECT_VIOLATIONS_HISTORY_DIFF_CACHE = "group_project_violations_history_diff";
    public static final String GROUP_PROJECT_SUMMARY_CACHE = "group_project_summary";
