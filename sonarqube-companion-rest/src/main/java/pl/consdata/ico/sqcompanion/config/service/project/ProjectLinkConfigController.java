...
public class ProjectLinkConfigController extends SettingsExceptionHandler {
    ...
    @GetMapping(value = "/{groupUuid}/projectLinks", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(value = "/{groupUuid}/projectLinks/create", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
    ...
    @ApiOperation(value = "Update project link",
            ...
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE)
    @PostMapping(value = "/{groupUuid}/projectLinks/update", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
    ...
    @ApiOperation(value = "Delete project link",
            httpMethod = "DELETE",
            produces = MediaType.APPLICATION_JSON_VALUE)
    @DeleteMapping(value = "/{groupUuid}/projectLinks/{projectLinkUuid}", produces = MediaType.APPLICATION_JSON_VALUE)
